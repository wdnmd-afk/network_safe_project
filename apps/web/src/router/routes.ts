...
export const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    props: { category: "api", scene: "property-authorization", variant: "vuln" },
  },
  {
    path: "/labs/api/property-authorization/fixed",
    name: "lab-api-property-authorization-fixed",
    component: () => import("../views/ControlledDecisionLabView.vue"),
  ...
  },
  {
    ...
    component: () => import("../views/ControlledDecisionLabView.vue"),
    props: { category: "business-logic", scene: "race-condition", variant: "vuln" },
  },
  {
    path: "/labs/business-logic/race-condition/fixed",
    name: "lab-business-logic-race-condition-fixed",
    component: () => import("../views/ControlledDecisionLabView.vue"),
    props: { category: "business-logic", scene: "race-condition", variant: "fixed" },
  },
  {
    path: "/labs/crypto/secret-lifecycle-audit/vuln",
    name: "lab-crypto-secret-lifecycle-audit-vuln",
    component: () => import("../views/ControlledDecisionLabView.vue"),
    props: { category: "crypto", scene: "secret-lifecycle-audit", variant: "vuln" },
  },
  {
    path: "/labs/crypto/secret-lifecycle-audit/fixed",
    name: "lab-crypto-secret-lifecycle-audit-fixed",
    component: () => import("../views/ControlledDecisionLabView.vue"),
    props: { category: "crypto", scene: "secret-lifecycle-audit", variant: "fixed" },
  },
  {
    path: "/labs/host/event-log-triage/vuln",
    name: "lab-host-event-log-triage-vuln",
    component: () => import("../views/ControlledDecisionLabView.vue"),
    props: { category: "host", scene: "event-log-triage", variant: "vuln" },
  },
  {
    path: "/labs/host/event-log-triage/fixed",
    name: "lab-host-event-log-triage-fixed",
    component: () => import("../views/ControlledDecisionLabView.vue"),
