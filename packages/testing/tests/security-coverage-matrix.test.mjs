...
test("security coverage matrix matches all current lab metadata", () => {
  ...
  // LT-006/007/008/009/010 分别把 clickjacking、open-redirect、credential-stuffing、session-hijacking、oauth 从引导式毕业为专用实验。
  assert.equal(summary.dedicated, 32);
  assert.equal(summary.guided, 33);
